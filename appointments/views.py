...
def book_appointment(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if existing.exists():
                messages.error(
                    request, "This time slot is already booked. Please choose another."
                )
            else:
                ...
                messages.success(
                    request,
                    "Appointment booked! Your appointment ID is #{}.".format(appt.id),
                )
...
def my_appointments(request):
    ...
    return render(
        request, "appointments/my_appointments.html", {"appointments": appointments}
    )
